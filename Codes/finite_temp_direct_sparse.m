...
function [somme_entropie, entropie, border_variance,variance, moyenne_temp,t_max_sortie,temp,grad, variance_grad]=finite_temp_direct_sparse(cond_haute,cond_basse,temp_puits,pas_x,p_vol,condi_limites);
